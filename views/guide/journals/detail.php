<?php
// views/guide/journals/detail.php
?>

<div class="card" style="margin-bottom: 24px;">
  <div class="card-header">
    <h3><i class="fas fa-book-open"></i> Chi tiết nhật ký</h3>
    <div style="display: flex; gap: 12px;">
      <a href="?act=guide-journal-edit&id=<?= $journal['id'] ?>" class="btn btn-sm" style="background: var(--warning); color: white;">
        <i class="fas fa-edit"></i> Chỉnh sửa
      </a>
      <a href="?act=guide-journals" class="btn btn-sm" style="background: var(--bg-light); color: var(--text-dark);">
