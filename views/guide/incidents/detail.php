<?php
// views/guide/incidents/detail.php
?>
...
<div class="card">
  <div class="card-header">
    ...
    <div style="display: flex; gap: 12px;">
      ...
      <a href="?act=guide-incident-edit&id=<?= $incident['id'] ?>" class="btn btn-sm" style="background: var(--warning); color: white;">
  ...
  <div class="card-body">
    ...
    <div style="display: grid; gap: 24px; max-width: 800px;">
      ...
      <div>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 12px;">
          <?php foreach ($images as $image): ?>
            <a href="<?= BASE_URL . $image ?>" target="_blank" style="display: block;">
              <img src="<?= BASE_URL . $image ?>" alt="Hình ảnh sự cố" style="width: 100%; height: 150px; object-fit: cover; border-radius: 8px; border: 1px solid var(--border); cursor: pointer;">
            </a>
          <?php endforeach; ?>
        </div>
      </div>
      ...
      <div style="display: flex; gap: 12px; margin-top: 24px; padding-top: 24px; border-top: 1px solid var(--border);">
        <a href="?act=guide-incident-edit&id=<?= $incident['id'] ?>" class="btn" style="background: var(--warning); color: white; flex: 1;">
          <i class="fas fa-edit"></i> Chỉnh sửa
        </a>
        <a href="?act=guide-incident-delete&id=<?= $incident['id'] ?>" class="btn" style="background: var(--danger); color: white; flex: 1;" onclick="return confirm('Bạn có chắc muốn xóa báo cáo sự cố này?')">
