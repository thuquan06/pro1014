<?php
/**
 * Sửa Hướng dẫn viên - Modern Interface
 * UC-Assign-Guide: Cập nhật thông tin HDV
 */
...
if (!$guide) {
    echo '<div style="padding: 20px; background: #fee2e2; color: #991b1b; border-radius: 8px;">Không tìm thấy HDV</div>';
    exit;
}

// Parse JSON arrays từ guide
...
<form method="POST" action="<?= BASE_URL ?>?act=admin-guide-edit&id=<?= $guide['id'] ?>">
  <div class="form-card">
