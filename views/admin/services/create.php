<?php
/**
 * Tạo Dịch vụ - Modern Interface
 * UC-Assign-Services: Tạo dịch vụ mới
 */
...
<form method="POST" action="<?= BASE_URL ?>?act=admin-service-create">
  <div class="form-card">
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
      ...
      <div class="form-group-modern">
        ...
        <input type="text" name="nha_cung_cap" placeholder="Tên đối tác/nhà cung cấp">
      </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
      <div class="form-group-modern">
        <label>Giá (VNĐ)</label>
        <input type="number" name="gia" step="0.01" min="0" placeholder="VD: 5000000">
      </div>

      <div class="form-group-modern">
        <label>Đơn vị tính</label>
        <input type="text" name="don_vi" placeholder="VD: chuyến, đêm, bữa, vé">
      </div>
    </div>

    <div class="form-group-modern">
      <label>Liên hệ</label>
      <input type="text" name="lien_he" placeholder="SĐT, Email, Địa chỉ...">
    </div>

    <div class="form-group-modern">
      <label>Mô tả</label>
      <textarea name="mo_ta" placeholder="Mô tả chi tiết về dịch vụ..."></textarea>
    </div>
    ...
    <div class="form-group-modern">
      <label>Ghi chú</label>
      <textarea name="ghi_chu" placeholder="Ghi chú bổ sung..."></textarea>
    </div>
  </div>
